...
#--------FUNCTIONS--------------------------------------------
def again(): 
    '''This functions asks a user if they'd like to enter another temp, checks the response for validity, and then returns a valid response back to the main program'''

    ans = input("\t\tWould you like to enter another temperature? [y/n]: ").lower()

    #user error trap loop
